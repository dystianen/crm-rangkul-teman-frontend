...
import { submitPreverificationReject } from "src/api/apploan";
...
export const RejectPopup: FC<any> = (props) => {
  ...
  const { popupVisible, hide, appId } = props;
  ...
  const onFormSubmit = (e: any) => {
    ...
    submitPreverificationReject(payload)
      .then(() => {
        hide();
        setToastConfig({
          ...toastConfig,
