...
export default function Index() {
    ...
    const seqIdRender = (rowData: any) => {
        return (<Button
            ...
            onClick={() => navigate(`/approval2/detail?id=${rowData.data.id}`)}
        />);
    };
    ...
    const onClickDownload = (e: any) => {
        ...
        let fileName = `persetujuan-oleh-pengurus.xlsx`;
        let columns = [];
        let captions = [];
        ...
        downloadExcel(`api/trx/approval/manual/2`, paramSearch)
            .then((response) => {
    ...
    return (<React.Fragment>
        <h2 className={"content-block"}>Persetujuan oleh pengurus</h2>
                    ...
                    <Column
                        ...
                        cellTemplate={function (container: any, options: any) {
                            ...
                            dom.render(<OnClickLink
                                          onClick={() => navigate(`/approval2/detail?id=${options.data.id}`)}>{options.data.seqId}</OnClickLink>);
                        }}
