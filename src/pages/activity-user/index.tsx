...
export const ActivityUserPage: FC = () => {
    ...
    const onClickDownload = (e: any) => {
        ...
        downloadExcel(`/api/backoffice/activity/log`, paramSearch)
            .then((response) => {
    ...
    return (<>
        <h2 className={"content-block"}>Aktivitas Pengguna</h2>
