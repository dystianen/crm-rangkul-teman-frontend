...
import {listProductByBranchStore} from "../../../api/product.branch.api";

const ProductByBranch = ({ productId }: { productId: string}) => {
  useEffect(() => {
  ...
  return (
	  <>
		<DataGrid
			id={"productByBranchGrid"}
			dataSource={listProductByBranchStore(productId)}
...
export default ProductByBranch;
